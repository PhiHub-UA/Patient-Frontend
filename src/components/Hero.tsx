  ...
  return (
    <section className='flex flex-row w-full justify-between p-[5%]'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <Button variant="outline" className="border-2 border-secondary" >Mark a new Appointment</Button>
          <Link to="/appointments">
          <Button variant ="outline" className="border-2 border-secondary" >Check my old appointments</Button>
          </Link>
          </div>
          )}
        </div>
